          ...
          <div className="text-center">
            <div className="flex items-center justify-center space-x-2 mb-8">
              <span className="text-4xl font-bold text-black">
                IDE<span className="text-green-500">A</span>
              </span>
              <span className="text-2xl font-bold text-black">TRADE</span>
            </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="อีเมล"
                className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg bg-gray-50 focus:ring-2 focus:ring-green-500 focus:border-transparent"
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg bg-gray-50 focus:ring-2 focus:ring-green-500 focus:border-transparent"
              />
              <button
                type="button"
            ...
            <div className="space-y-3">
              <button
                type="button"
                className="w-full bg-green-100 text-green-700 py-3 rounded-lg font-medium hover:bg-green-200 transition-colors flex items-center justify-center space-x-2"
              >
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-gray-400">
            ...
            <p className="mt-4 text-lg">Financial Trading Platform</p>
          </div>
        </div>
      </div>
    </div>
