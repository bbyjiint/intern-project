  ...
  useEffect(() => {
    const loadJobPosts = async () => {
      try {
        setLoading(true);
        setError(null);
        const data = await apiFetch<{ jobPosts: JobPostData[] }>("/api/job-posts/public");
        ...
        <div className="flex-1 p-6 lg:p-10 overflow-y-auto">
          <div className="layout-container">
            ...
            {loading ? (
              ...
              <div className="text-center py-20 text-red-500 bg-white rounded-xl shadow-sm border border-gray-100">
                {error}
              </div>
