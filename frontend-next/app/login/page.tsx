          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="อีเมล"
                className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg bg-gray-50"
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg bg-gray-50"
              />
              <button
                type="button"
