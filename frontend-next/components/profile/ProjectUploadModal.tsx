...
export default function ProjectUploadModal({
  ...
  useEffect(() => {
    if (project) {
      ...
      setFile(null); // reset ไฟล์ใหม่ที่เลือก
    }
  }, [project, isOpen]);
    ...
    try {
      ...
      await apiFetch(`/api/candidates/projects/${project.id}`, {
        ...
        body: JSON.stringify({
          ...
          fileName: file ? file.name : project?.fileName || "",
        }),
      });
      ...
      >
        ...
        <div className="p-6 space-y-6 overflow-y-auto flex-1">
          ...
          <div>
            ...
            {/* ถ้ามีไฟล์เดิมและยังไม่ได้เลือกไฟล์ใหม่ */}
        ...
        ${
          isDragging
            ...
            : file
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl shadow-sm flex items-center justify-center mb-4 transition-transform group-hover:scale-105
