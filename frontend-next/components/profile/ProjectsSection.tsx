            ...
            return (
              ...
              >
                <div className="absolute top-6 right-6">
                  <div
                    className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold border ${hasAnyFile ? "bg-green-50 text-green-600 border-green-200" : "bg-blue-50 text-blue-600 border-blue-200"}`}
                  >
                    <div
                ...
                <div className="flex items-center justify-between border-t border-gray-50 pt-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={`px-4 py-1.5 border-2 rounded-lg text-sm font-bold transition-all ${hasAnyFile ? "border-blue-600 text-blue-600 hover:bg-blue-50" : "border-gray-200 text-gray-500 hover:bg-gray-50"}`}
                    >
