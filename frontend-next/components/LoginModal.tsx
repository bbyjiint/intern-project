...
export default function LoginModal({ isOpen, onClose, onSignUpClick }: LoginModalProps) {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto border border-transparent dark:border-gray-800 transition-colors duration-200">
        <div className="p-8 relative">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            {error && (
              <div className="rounded-xl border border-red-200 bg-red-50 dark:bg-red-900/20 dark:border-red-800 px-4 py-3 text-sm font-bold text-red-700 dark:text-red-400 animate-shake">
                {error}
              </div>
            )}
            ...
            <button
              ...
              className="w-full text-white py-3.5 rounded-xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg active:scale-[0.98] shadow-blue-500/20"
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 bg-white dark:bg-gray-900 text-gray-500 font-bold uppercase tracking-widest">Or</span>
              </div>
            </div>
