...
export default function CompanyInfoEditPopup({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="relative w-full max-w-[700px] rounded-[14px] bg-white shadow-xl">
        {/* Header */}
        <div className="border-b border-[#E5E7EB] px-[24px] py-[18px]">
            ...
            <div className="space-y-[16px]">
              ...
              <div>
                ...
                <select
                  ...
                  className="h-[38px] w-full rounded-[6px] border border-[#D1D5DB] bg-white px-[14px] text-[14px] text-[#64748B] outline-none transition focus:border-[#0273B1] focus:ring-2 focus:ring-[#BFDBFE]"
                >
              ...
              <div>
                ...
                <div className="flex flex-col gap-y-2 pt-[1px]">
                  <label className="flex cursor-pointer items-center gap-[10px] text-[14px] text-[#6B7280]">
                    <input
                      type="radio"
                      name="businessType"
                      value="private"
              ...
              <div>
                ...
                <p className="mb-[8px] text-[13px] leading-[1.4] text-[#6B7280]">
            ...
            <div className="flex flex-col items-center">
              {formData.companyLogo ? (
                <div className="w-full">
                  <div className="relative overflow-hidden rounded-[8px] border border-[#E5E7EB] bg-[#F3F4F6]">
                    <img
                    ...
                    <button
                      ...
                      className="absolute bottom-2 right-2 flex h-[30px] w-[30px] items-center justify-center rounded-full bg-white shadow-md transition hover:bg-gray-50"
                    >
                      <svg
                        className="h-4 w-4 text-[#0273B1]"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                ...
                <label className="block cursor-pointer w-full">
                  <div className="flex h-[150px] w-full items-center justify-center rounded-[8px] border border-[#E5E7EB] text-center transition hover:bg-[#EDF2F7] bg-[#EFF2F4]">
                    <div className="flex items-center gap-[10px]">
                      <div className="flex h-[18px] w-[18px] items-center justify-center rounded-full bg-[#0273B1] text-[14px] text-white">
                        +
                      </div>
                      <span className="text-[13px] font-semibold text-[#334155]">Add Picture</span>
                    </div>
                  </div>
                  <input
                    ref={fileInputRef}
        ...
        {/* Footer - Buttons */}
        <div className="border-t border-[#E5E7EB] px-[24px] py-[18px] flex justify-end gap-3">
          <button
            type="button"
            onClick={onClose}
            disabled={isSaving}
            className="rounded-[6px] border border-[#D1D5DB] bg-white px-[18px] py-[8px] text-[14px] font-semibold text-[#374151] transition hover:bg-[#F9FAFB] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
          <button
            ...
            onClick={handleSave}
            disabled={isSaving}
            className="rounded-[6px] bg-[#0273B1] px-[18px] py-[8px] text-[14px] font-semibold text-white transition hover:bg-[#0263A1] disabled:opacity-50 disabled:cursor-not-allowed"
          >
