        ...
        >
          <div>
            ...
            <input
              ...
              className="h-[42px] w-full rounded-[8px] border border-[#CBD5E1] bg-white px-3 text-[13px] text-[#111827] outline-none placeholder:text-[#9CA3AF] focus:border-[#94A3B8] dark:border-gray-700 dark:bg-gray-900/50 dark:text-white dark:placeholder:text-gray-500"
              required
            />
          </div>
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  className="h-[42px] w-full rounded-[8px] border border-[#A3A3A3] bg-white px-3 pr-9 text-[13px] text-[#111827] outline-none placeholder:text-[#8A8A8A] dark:border-gray-700 dark:bg-gray-900/50 dark:text-white dark:placeholder:text-gray-500"
                />
              ...
              <div className="w-[110px]">
                <select
                  ...
                  className="h-[42px] w-full appearance-none rounded-[8px] border border-[#A3A3A3] bg-white px-3 text-[13px] text-[#404040] outline-none dark:border-gray-700 dark:bg-gray-900/50 dark:text-slate-200"
                >
          ...
          <div>
            ...
            <textarea
              ...
              className="min-h-[160px] w-full resize-y rounded-[8px] border border-[#CBD5E1] bg-white px-3 py-2.5 text-[13px] text-[#111827] outline-none placeholder:text-[#9CA3AF] focus:border-[#94A3B8] dark:border-gray-700 dark:bg-gray-900/50 dark:text-white dark:placeholder:text-gray-500"
              required
            />
          </div>
          ...
          <div>
            ...
            <div className="relative" ref={positionsDropdownRef}>
              <button
                ...
                className="flex h-[42px] w-full items-center justify-between rounded-[8px] border border-[#CBD5E1] bg-white px-3 text-left text-[13px] text-[#111827] outline-none placeholder:text-[#9CA3AF] focus:border-[#94A3B8] dark:border-gray-700 dark:bg-gray-900/50 dark:text-white dark:placeholder:text-gray-500"
              >
                <span
                  className={
          ...
          <div>
            ...
            {provincesLoading ? (
              <div className="flex h-[42px] w-full items-center justify-center rounded-[8px] border border-[#CBD5E1] bg-gray-50 dark:border-gray-700 dark:bg-gray-900/50">
          ...
          <div className="flex justify-end gap-2 pt-1">
            <button
              type="button"
              onClick={onClose}
            className="flex h-[38px] items-center justify-center rounded-[10px] border border-[#D1D5DB] bg-white px-5 text-[13px] font-semibold text-[#374151] transition hover:bg-[#F9FAFB] dark:border-gray-700 dark:bg-gray-900/50 dark:text-slate-200 dark:hover:bg-gray-700"
            >
              Cancel
            </button>
            <button
