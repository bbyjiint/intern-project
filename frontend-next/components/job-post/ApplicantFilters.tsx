...
export default function ApplicantFilters({
  ...
  return (
    <>
      {/* Filter Card */}
      <div className="mb-[16px] rounded-[16px] bg-white px-6 py-5 shadow-[0_2px_10px_rgba(15,23,42,0.06)]">
        ...
        <div className="mb-4 grid grid-cols-[1fr_16px_1fr_1fr_2fr] items-end gap-3">
          ...
          <div className="flex items-center justify-center pb-[2px] text-[16px] text-[#9CA3AF]">–</div>
          <div>
            <label className="invisible mb-1.5 block text-[13px] font-semibold text-[#374151]">End</label>
            <input
              type="date"
          ...
          <div>
            ...
            {universitiesLoading ? (
              <div className="flex h-[42px] w-full items-center rounded-[8px] border border-[#D1D5DB] bg-gray-50 px-3">
      ...
      <p className="mb-[16px] text-[14px] font-semibold text-[#1F2937]">
