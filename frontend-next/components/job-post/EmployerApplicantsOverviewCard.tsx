...
export default function EmployerApplicantsOverviewCard({ post }: EmployerApplicantsOverviewCardProps) {
  return (
    <div className="relative flex h-full min-h-[274px] flex-col rounded-[12px] bg-white px-[20px] py-[18px] shadow-[0_2px_10px_rgba(15,23,42,0.05)]">
      ...
      <div className="mb-[9px] flex items-start justify-between gap-4">
        <div className="flex items-start gap-[14px]">
          ...
          <div className="min-w-0 pt-[1px]">
            <h3 className="truncate text-[15px] font-bold leading-tight text-[#111827]">{post.companyName}</h3>
      ...
      <h2 className="mb-[7px] min-h-[34px] text-[16px] font-bold leading-snug text-[#111827]">{post.title}</h2>
